...
/**
 * A two column layout for the rutatic theme.
 *
...
$coursepresentation = theme_rutatic_get_setting('coursepresentation');
...
theme_rutatic_boostnavigation_extend_navigation($PAGE->navigation);
...
if (!$coursepresentation || $coursepresentation == 1) {
    echo $OUTPUT->render_from_template('theme_rutatic/course', $templatecontext);
} else if ($coursepresentation == 2) {
    echo $OUTPUT->render_from_template('theme_rutatic/course_cover', $templatecontext);
}
